...
def main() -> None:
    parser = build_parser("Call the /run-inference endpoint.")
    ...
    payload = {"gpu_id": args.gpu_id, "api_port": args.api_port, "item_name": args.item_name}
    request_json("POST", f"{args.base_url}/run-inference", payload)
