...
Therefore, the integration of the RLM with robotic boxes enables a closed AI–robotics discovery process in which specialised language modelling and robotic hardware continuously improve one another, suggesting an evolution of physical AI for materials research.
