...
train = pd.read_csv('df_20250612_Jsc_xgb_train_6451.csv')
test = pd.read_csv('df_20250612_Jsc_xgb_test_6451.csv')
...
joblib.dump(col, 'xgb_col_Jsc.pkl')

std = StandardScaler()
X_fit = std.fit(X_train)
joblib.dump(std, "xgb_scaler_Jsc.pkl")
...
joblib.dump(xgb, "xgb_model_Jsc.pkl")
