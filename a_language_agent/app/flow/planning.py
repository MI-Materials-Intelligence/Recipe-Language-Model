...
class PlanningFlow(BaseFlow):
    ...
    async def execute(self, input_text: str) -> str:
        ...
        try:
            ...
            while True:
                ...
                print(f"Current step: {self.current_step_index} - {step_info}")
    ...
    async def _create_initial_plan(self, request: str) -> None:
        ...
        system_message_content = (
            ...
            """
            You will use the following functional nodes in sequence:
            0. Learning
            1. Generating
            2. F-P Corpora
            3. Fine-Tuning
            ...
            You must:
            1. Follow a seven-stage plan: Learning → Generating → F-P Corpora → Fine-Tuning → Optimization → Reasoning → Evaluation
            2. Focus on key milestones, not overly detailed sub-steps.
            3. Optimize for clarity and efficiency in both content and workflow.
            """
        )
        agents_description = []
        for key in self.executor_keys:
