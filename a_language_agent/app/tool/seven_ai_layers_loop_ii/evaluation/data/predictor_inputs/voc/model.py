...
train = pd.read_csv('df_20250612_Voc_xgb_train_8418.csv')
test = pd.read_csv('df_20250612_Voc_xgb_test_8418.csv')
...
joblib.dump(col, 'xgb_col_Voc.pkl')

std = StandardScaler()
X_fit = std.fit(X_train)
joblib.dump(std, "xgb_scaler_Voc.pkl")
...
joblib.dump(xgb, "xgb_model_Voc.pkl")
