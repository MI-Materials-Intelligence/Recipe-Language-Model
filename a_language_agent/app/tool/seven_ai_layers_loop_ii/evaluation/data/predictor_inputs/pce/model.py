...
train = pd.read_csv('df_20250710_xgb_train_6776.csv')
test = pd.read_csv('df_20250710_xgb_test_6776.csv')
...
# joblib.dump(col, 'xgb_col_PCE.pkl')

std = StandardScaler()
X_fit = std.fit(X_train)
# joblib.dump(std, "xgb_scaler_PCE.pkl")
...
# joblib.dump(xgb, "xgb_model_PCE.pkl")
