...
perovskite_formula_segments = [
    ...
    "The perovskite precursor solution ({formula_pvk}) was prepared with a concentration of {concentration_pvk} mol/L in a mixed anhydrous solvent of DMF/DMSO (4/1, v/v).",  # 20250424文献模板
...
antisolvent_segments = [
    ...
    "After {antisolvent_timing} s into the second stage, {antisolvent_volume} µL chlorobenzene antisolvent was dropped on top of the spinning substrates.", # 20250411文献模板
    ...
    "At the last {antisolvent_timing} s of the second step, {antisolvent_volume} µL anisole was dropped as antisolvent.", # 20250411文献模板
    ...
    "In the last {antisolvent_timing} s of the second step, the anti-solvent ({antisolvent_volume} µL of chlorobenzene) was dropped in the center at a constant rate", # 20250411文献模板
    ...
    "{antisolvent_volume} µL of chlorobenzene was quickly poured to extract the mixed solvents at the last of {antisolvent_timing} s.", # 20250411文献模板
    ...
    "In the last {antisolvent_timing} s of the second step, the anti-solvent ({antisolvent_volume} µL of CB) was dropped in the center of the substrate at a constant rate within 1 s.",  # 20250424文献模板
    ...
    "After {antisolvent_timing} s, {antisolvent_volume} µL chlorobenzene as antisolvent was casted vertically.",  # 20250424文献模板
    "At the {antisolvent_timing} s of the spin-coating process, {antisolvent_volume} µL anti-solvent was rapidly poured onto the perovskite film.",  # 20250424文献模板
    "After {antisolvent_timing} s of the second spin-coating step, {antisolvent_volume} µL of chlorobenzene was dripped onto the center of the substrate to induce fast crystallization of the perovskite film.",  # 20250424文献模板
    "During the spin-coating process, {antisolvent_volume} µL of CB as anti-solvent was quickly dropped onto the samples at a delay time of {antisolvent_timing} s.",  # 20250424文献模板
    "{antisolvent_volume} µL of antisolvents was dripped on the spinning substrate during the {antisolvent_timing} s of the second spin-coating step.",  # 20250424文献模板
    ...
    "In the last {antisolvent_timing} s of the second step, the anti-solvent ({antisolvent_volume} µL of chlorobenzene) was dropped in the center at a constant rate within 1 s.",  # 20250424文献模板
    ...
    "During the second step end of {antisolvent_timing} s, {antisolvent_volume} µL of ethyl acetate was drop-coated to treat the perovskite films.",  # 20250424文献模板
    "After {antisolvent_timing} s, {antisolvent_volume} µL of anti-solvent was rapidly dropped on top of the spinning substrate.",  # 20250424文献模板
    "During the second spin-coating step, {antisolvent_volume} µL of EA was quickly poured onto the substrate after {antisolvent_timing}.",  # 20250424文献模板
    ...
    "Immediately before the end spin-coating process, {antisolvent_volume} µL of anisole was dropped onto the films.",  # 20250424文献模板
    ...
    "The film was quickly washed with {antisolvent_volume} µL toluene at {antisolvent_timing} s during spin-coating.",  # 20250424文献模板
    "At the {antisolvent_timing} s of spinning, {antisolvent_volume} µL of anti-solvent chlorobenzene was dripped at the center.",  # 20250424文献模板
    "After {antisolvent_timing} s into spin-coating procedure, {antisolvent_volume} µL diethyl ether was dripped onto the spinning substrate.",  # 20250424文献模板
    "During the last step, {antisolvent_volume} µL of chlorobenzene was dropped on the film at {antisolvent_timing} s.",  # 20250424文献模板
    "In the second step, {antisolvent_volume} µL anisole was dropped onto the substrate during the last {antisolvent_timing} s of the spinning.",  # 20250424文献模板
    "{antisolvent_volume} µL CB as the antisolvent was dripped on the film at {antisolvent_timing} s before the end of the last procedure.",  # 20250424文献模板
    "After {antisolvent_timing} s, {antisolvent_volume} µL CB was dropped on the film.",  # 20250424文献模板
    "{antisolvent_volume} µL anisole was dropped onto the substrate during the last {antisolvent_timing} s of the spinning, resulting in the formation of dark brown films.",  # 20250424文献模板
    "{antisolvent_volume} µL CB was dripped onto the center of film at {antisolvent_timing} s before the end of spin-coating.",  # 20250424文献模板
    ...
    "{antisolvent_volume} µL of antisolvent was dripped onto the substrate during spinning.",  # 20250424文献模板
    ...
    "At the last {antisolvent_timing} s of the second step, {antisolvent_volume} µL anisole was dropped as antisolvent.",  # 20250424文献模板
    ...
    "{antisolvent_volume} µL of antisolvent was drop-coated onto the substrate while spinning.",  # 20250424文献模板
    "{antisolvent_volume} µL of CB was dropped on the perovskite film within {antisolvent_timing} s into the spin coating process.",  # 20250424文献模板
    ...
    "At the {antisolvent_timing} s of spinning, {antisolvent_volume} µL of antisolvent was dripped onto the substrate centre.",  # 20250424文献模板
    "After {antisolvent_timing} s into the second stage, {antisolvent_volume} µL chlorobenzene antisolvent was dropped on top of the spinning substrates (about 1 cm distance).",  # 20250424文献模板
    ...
    "At the {antisolvent_timing} s of the second step, {antisolvent_volume} µL anisole was dropped as antisolvent.",  # 20250424文献模板
    ...
    "With {antisolvent_timing} s of spin time remaining, CB ({antisolvent_volume} µL) was slowly dispensed onto the middle of the substrate.",  # 20250424文献模板
